/*
 * Данный код из статьи - https://habr.com/ru/post/348262/
 * Переделан для использования в VS2010 и C#4.0
 */
...
namespace SnakeGame
{
    class Game
    {
     ...
     struct Point
     {
         ...
         public static Point NewPoint(int Item1, int Item2, char Item3)
         {
              return new Point {x = Item1, y = Item2, ch = Item3};
         }
     ...
     class FoodFactory
     {
         ...
         {
             food = Point.NewPoint(random.Next(2, x - 2), random.Next(2, y - 2), ch);
             food.Draw();
         }
     }
}